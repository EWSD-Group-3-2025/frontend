...
>(({ className, children }, ref) => {
	return (
		<CommandList
			ref={ref}
			className={cn(
				'scrollbar-thin scrollbar-track-transparent scrollbar-thumb-muted-foreground dark:scrollbar-thumb-muted scrollbar-thumb-rounded-lg absolute top-0 z-10 flex h-28 w-full flex-col gap-2 rounded-md border border-muted bg-background p-2 shadow-md transition-colors',
				className
			)}
		>
			{children}
...
>(({ className, value, children, ...props }, ref) => {
	...
	return (
		<CommandItem
			...
			className={cn(
				'flex cursor-pointer justify-between rounded-md p-2 transition-colors',
				className,
